...
\vspace*{2in}
\begin{center}
\textit{For ...}  % TODO(Héctor): replace with your dedication.
\end{center}
\end{dedication}
...
Gomez and Professor Leilani H. Gilpin, for their time, their sharp questions, and
...
Finally, I thank my family and friends for their support and patience throughout this
work. % TODO(Héctor): name the people who matter most to you here.
...
edited the manuscripts. % TODO(Héctor): verify these attributions against your
% co-authors' recollection before submitting, and adjust any that are not exactly right.
