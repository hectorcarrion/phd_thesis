...
% Optional Creative Commons grant printed under the copyright notice. Note that
% holding copyright is what makes granting this licence possible -- the notice
% above and the licence below are complementary, not alternatives.
\licensenotice{This work is licensed under a Creative Commons
...
% Preliminary-page order is mandated by the UCSC Graduate Division
% ("Dissertation and Thesis Preparation Guidelines", Rev July 2026):
%   1. Title page  2. Copyright  3. Table of Contents
%   4. List of Figures (and/or Tables)  5. Abstract
%   6. Dedication and/or Acknowledgments  7. Text
% Title page = i and copyright = ii (both counted, neither printed);
% the Table of Contents starts at printed page iii.
...
% Dedication. UCSC lists this before the Acknowledgments and treats it as optional
% ("If you wish, you may include a page with a brief note of dedication...").
% NOTE: the class's dedication environment prints NO heading -- by convention a
% dedication is just a short centred line. If you would rather it carry a visible
% "Dedication" title to match the Acknowledgments page, add this as the first line
% inside the environment:
%     \begin{center}{\large\bfseries \dedicationname}\end{center}\bigskip
% Do not leave this environment empty: it would render as a numbered blank page
% with a Table of Contents entry pointing at nothing.
\begin{dedication}
\vspace*{2in}
\begin{center}
\textit{Dedicado a mi abuelita Lydia Zoraida Barreto Ramos (Shanti Ragyi), por reenfocarme continuamente en ser feliz, comer bien y disfrutar de la bendición que es vivir en paz, armonía y bienestar. Te amo con todo mi corazón, Shan Shan.}
\end{center}
\end{dedication}
...
% ---------------------------------------------------------------------------
% DRAFT -- please rewrite the personal paragraphs in your own voice.
% The final two paragraphs are NOT optional: UCSC requires a reprint statement
% and a detailed per-publication contribution statement whenever chapters are
% reprints of published, co-authored work (Guidelines Rev July 2026, Sec. G).
% ---------------------------------------------------------------------------

First and foremost, I thank my advisor, Professor Narges Norouzi, who has shaped this
work and my development as a researcher more than anyone. She gave me the freedom to
follow problems I found genuinely interesting, the honesty to tell me when an idea was
not working, and the persistence to keep pushing when the results were not yet there.
Whatever is careful and rigorous in this dissertation, I learned from her.

I am grateful to the members of my dissertation reading committee, Professor Marcella
Gomez and Professor Leilani H. Gilpin, as well as Professor Yuyin Zhou for their time, their sharp questions, and
feedback that repeatedly made this work stronger.

This research would not have been possible without my collaborators. I thank Mohammad
Jafari, Hsin-ya Yang, Roslyn Rivkah Isseroff, Marco Rolandi, and Marcella M. Gomez for
the interdisciplinary partnership behind the wound-healing work that opened this line of
research, and for showing me what it looks like when engineering and clinical practice
are made to speak to one another.

I also thank the researchers and institutions who made their data available. This
dissertation rests on the Diverse Dermatology Images dataset, SKINL2, WoundsDB, and
Fitzpatrick17k; datasets built with real care for representation, without which none of
the fairness results reported here could have been measured at all. My thanks as well to
the anonymous reviewers whose criticism materially improved each of these chapters.

The text of this dissertation includes reprints of the following previously published
material: H.~Carrión, M.~Jafari, H.~Yang, R.~R.~Isseroff, M.~Rolandi, M.~M.~Gomez, and
N.~Norouzi, ``HealNet -- Self-Supervised Acute Wound Heal-Stage Classification,''
\emph{Machine Learning in Medical Imaging (MLMI), held in conjunction with MICCAI},
Lecture Notes in Computer Science, Springer, 2022 (Chapter~\ref{section:healnet});
H.~Carrión and N.~Norouzi, ``FEDD -- Fair, Efficient, and Diverse Diffusion-based Lesion
Segmentation and Malignancy Classification,'' \emph{International Conference on Medical
Image Computing and Computer-Assisted Intervention (MICCAI)}, Lecture Notes in Computer
Science, Springer, 2023 (Chapter~\ref{section:fedd}); H.~Carrión and N.~Norouzi,
``Controllable Generation of Diverse Dermatological Imagery for Fair and Efficient
Malignancy Classification,'' \emph{MICCAI}, 2026, accepted for publication
(Chapter~\ref{section:cgddi}); and H.~Carrión and N.~Norouzi, ``DermDepth: Toward
Monocular Metric Scale 3D Reconstruction Models for Dermatology,'' \emph{MICCAI}, 2026,
accepted for publication (Chapter~\ref{section:dermdepth}). The co-author Narges Norouzi
listed in these publications directed and supervised the research which forms the basis
for this dissertation.

For all four multi-authored publications, I was the first author and lead investigator.
I formulated the research questions, designed and implemented the methods, built and
curated the datasets, ran all experiments and ablations, performed the analyses, produced
the figures, and wrote the manuscripts. For ``HealNet,'' M.~Jafari, H.~Yang,
R.~R.~Isseroff, M.~Rolandi, and M.~M.~Gomez designed and conducted the underlying murine
wound-healing study and provided the longitudinal imagery and domain expertise used for
the heal-stage analysis, and contributed to manuscript revision; the self-supervised
method, its implementation, and its evaluation are my own contribution. For ``FEDD,''
``Controllable Generation of Diverse Dermatological Imagery,'' and ``DermDepth,''
N.~Norouzi supervised the research, advised on experimental design and framing, and
edited the manuscripts.

Finalmente, quiero reconocer e agradecer a mi familia y amistades por su apoyo y paciencia durante la época más retante de mi vida. Gracias por estar conmigo antes, durante y después de tanto sacrificio: a mi papá Yakeen Carrión, a mi mamá Carmen Rivera, a los seres especiales que cruzaron por mi trayectoria y a la gente linda de mi pueblo, Puerto Rico.
...
To further evaluate the quality of the clusters, we examined the images in each cluster (separately for young and aged mice). The median wound age (in days) and first and third quartile of wound age are calculated for each cluster. As can be seen from Fig. \ref{fig:stage}, images in each of the clusters contain visual cues for hemostasis (fresh and clearly defined wound-edge), inflammation (swelling of the wound edge, wet and shiny appearance), proliferation (dry and matte appearance with rough and uneven texture), and maturation (complete or near-complete wound closure). In addition, there is a clear temporal progression in the median wound day age that also differentiates our clusters. It would be interesting to note that a difference in wound healing rates between young and aged mice is evident in the first, second, and third quartiles of each cohort. Previous work on this dataset \cite{carrion2021automatic} also reported a similar divergence in wound-size progression between young and aged mice, consistent with these results. These two aspects are used in relating each cluster to a matching heal-stage. To validate these assignments, a blind survey of 5 human non-experts was conducted, in which we found a top-1 agreement of over 80\% between the self-supervised and human labels. The temporal distribution of clusters is visualized in the box plots of Fig.~\ref{fig:stage}, and Table \ref{tab:table2} reports human annotator agreement per data split.
