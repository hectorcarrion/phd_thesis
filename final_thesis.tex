...
The remainder of the dissertation traces this arc. Each method chapter is a self-contained paper-length contribution --- HealNet \cite{Carrin2022HealNet} and FEDD \cite{Carrion2023FEDDF} have been peer-reviewed and published, while cgDDI and DermDepth are currently under review at ICLR 2026 and MICCAI 2026 respectively --- and the chapters also extend one another along the arc above. The chapter-specific Background and Related Work sections that follow expand the prior-art discussion with the level of method-specific detail that each chapter's claims require.
