...
% A Dedication is OPTIONAL (UCSC: "If you wish, you may include a page..."). It is
% left out deliberately: the class's dedication environment prints no heading, so an
% empty one renders as a numbered blank page with a Table of Contents entry pointing
% at nothing. To add one, uncomment and write the text:
%
% \begin{dedication}
% \begin{center}\textit{For ...}\end{center}
% \end{dedication}
